...
| [GNU image Manipulation Program](https://www.gimp.org/) (GIMP) | free | - | - |
...
| Software | Price | OS | Notes |
| --- | --- | --- | --- |
| [brackets](http://brackets.io/)*** Transfer to [Visual Studio Code](https://code.visualstudio.com/) | free | windows, mac, linux | open source |
...
Place | About
–|–
[Minecraft Resource Pack Subreddit](https://www.reddit.com/r/mcresourcepack/)|A great place to share your resource pack or ask questions if you are having trouble.
[Planet Minecraft](https://www.planetminecraft.com/texture-packs/)|A goo place to ask for help or post your pack.
[Minecraft Forums](https://www.minecraftforum.net/forums/mapping-and-modding-java-edition/resource-packs)|Another good place to ask for help or post your pack.
[Pack Community Discord](discord.gg/packcommunity)| A discord for people making texturepacks and textures to showcase and get feedback
[PVPRP Discord](discord.gg/pvprp)| A discord for the PVPRP website, which also functions as a place to talk about texturepacks
...
![Default Textures](https://www.notion.so/assets/resourcepackguide/images/extracting-the-jar/default-textures.png)

Next go into the `block` folder:

![Default Block](https://www.notion.so/assets/resourcepackguide/images/extracting-the-jar/default-block.png)
...
![Search For Block](https://www.notion.so/assets/resourcepackguide/images/making-a-texture/block-search.png)

Right-click the image and click copy. Move back to your other window and paste it:

![Block Copied](https://www.notion.so/assets/resourcepackguide/images/making-a-texture/stone-copied.png)
...
![Gimp Open](https://www.notion.so/assets/resourcepackguide/images/making-a-texture/gimp-open.png)

That texture is tiny. Zoom in by holding down Ctrl and scrolling the mouse wheel in:

![Gimp Zoom](https://www.notion.so/assets/resourcepackguide/images/making-a-texture/gimp-zoom.png)
...
![Gimp Set Pencil To 1](https://www.notion.so/assets/resourcepackguide/images/making-a-texture/gimp-pencil-1.png)
...
![Stone Done](https://www.notion.so/assets/resourcepackguide/images/making-a-texture/stone-new.png)
...
![Gimp Overwrite](https://www.notion.so/assets/resourcepackguide/images/making-a-texture/stone-overwrite.png)
...
![move-To-Active](https://www.notion.so/assets/resourcepackguide/images/seeing-first-texture-in-game/move-to-active.png)
...
![Stone-In-Game](https://www.notion.so/assets/resourcepackguide/images/seeing-first-texture-in-game/stone-in-game.png)
...
![Sealantern Image](https://www.notion.so/assets/resourcepackguide/images/texture-animation/sea-lantern-png.png)
...
![Sealantern Mcmeta](https://www.notion.so/assets/resourcepackguide/images/texture-animation/sea-lantern-mcmeta.png)
...
![Glowstone Image](https://www.notion.so/assets/resourcepackguide/images/texture-animation/glowstone.png)
...
![Gimp Canvas](https://www.notion.so/assets/resourcepackguide/images/texture-animation/canvas.png)

A window will pop up like this:

![Gimp Height](https://www.notion.so/assets/resourcepackguide/images/texture-animation/canvas-hieght.png)
...
![Glowstone Six](https://www.notion.so/assets/resourcepackguide/images/texture-animation/glowstone-6.png)

Now, you need to make your edits to make it animated. I will make a simple expanding ring for demonstration:

![Glowstone Six Done](https://www.notion.so/assets/resourcepackguide/images/texture-animation/glowstone-6-done.png)
...
![Glowstone In Game](https://www.notion.so/assets/resourcepackguide/images/texture-animation/glowstone-in-game.gif)
...
![Honey Files](https://www.notion.so/assets/resourcepackguide/images/different-looks-different-states/bee-files.png)
...
![Honey Level In Game](https://www.notion.so/assets/resourcepackguide/images/different-looks-different-states/honey-level-in-game.png)
...
![Variants Files](https://www.notion.so/assets/resourcepackguide/images/variant-textures/6-diamond-textures.png)
...
![Copy Variant Models](https://www.notion.so/assets/resourcepackguide/images/variant-textures/variants-model-copy.png)

Now, you are going to want to open each model, and edit it to point to the correct texture, like this:

![Edit Variant Model Files](https://www.notion.so/assets/resourcepackguide/images/variant-textures/edit-models.png)

Once you have done that for all of them, we can go in game and try it out. Here are my results:

![Variants In Game](https://www.notion.so/assets/resourcepackguide/images/variant-textures/variants-in-game.png)
...
![Barrel Texture Files](https://www.notion.so/assets/resourcepackguide/images/weighted-variants/barrel-texture-files.png)
...
![Barrel closed In Game](https://www.notion.so/assets/resourcepackguide/images/weighted-variants/closed-barrel-in-game.png)

Here is what most of them look like when they are opened:

![Barrel Normal Open](https://www.notion.so/assets/resourcepackguide/images/weighted-variants/open-barrel-in-game.png)

Here is what is hiding inside 15% of them:

![Barrel Ponk Open](https://www.notion.so/assets/resourcepackguide/images/weighted-variants/ponk-barrel-in-game.png)
